            ...
            <div className="Navbar_Upper_Main">
                <div className="Navbar_Upper">
                    <div className="First_left">
                        <a href="#" className="UpperNav_Links">INTERNATIONAL</a>
                        <p>|</p>
                        <a href="#" className="UpperNav_Links">MI COMMUNITY</a>
                        <p>|</p>
                        <a href="#" className="UpperNav_Links">MIUI</a>
                        <p>|</p>
                        <a href="#" className="UpperNav_Links">XIAOMI STUDIOS</a>
                    </div>
                    <div className="First_right">
                        <Link to={'/'} className="UpperNav_Links">SIGN IN</Link>
                        <p>|</p>
                        <Link to={'/'} className="UpperNav_Links">SIGN UP</Link>
                    </div>
                </div>
            </div>
                ...
                <div className="Navbar_Lower">
                    ...
                    <div className="Hover_Nav_Links">
                        <div className="Hover_First">
                            <p className="Slider_Links" onMouseOver={HandleXiaomi}>Xiaomi Phones</p>
                            <p className="Slider_Links" onMouseOver={HandleRedmi}>Redmi Phones</p>
                            <p className="Slider_Links" onMouseOver={HandleAudio}>Audio</p>
                            <p className="Slider_Links" onMouseOver={HandleMi_TV}>Mi TV</p>
